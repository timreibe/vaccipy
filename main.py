...
from tools.utils import remove_prefix, cookies_erneuern
...
def run_search(kontaktdaten, check_delay):
    ...
    ImpfterminService.terminsuche(basepath=PATH, code=code, plz_impfzentren=plz_impfzentren,
                                  kontakt=kontakt, check_delay=check_delay)
